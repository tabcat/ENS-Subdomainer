...
contract HashRegistrar {
     ...
     */
    function HashRegistrar(ENS _ens, bytes32 _rootNode, uint _startDate) public {
        ens = _ens;
        rootNode = _rootNode;
    ...
    function transferRegistrars(bytes32 _hash) public onlyOwner(_hash) {
        ...
        HashRegistrar(registrar).acceptRegistrarTransfer(_hash, h.deed, h.registrationDate);
